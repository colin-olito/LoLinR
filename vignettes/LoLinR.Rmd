...
thinned_cormorant_data  <-  thinData(thinned_cormorant_data, by=3)$newData1
cormRegs  <-  rankLocReg(xall=thinned_cormorant_data$Time, yall=thinned_cormorant_data$VO2.ml.min, alpha=0.2, 
