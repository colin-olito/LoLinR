...
thinned_cormorant_data  <-  thinData(xall=thinned_cormorant_data$Time, yall=thinned_cormorant_data$VO2.ml.min, by=3)$newData1
cormRegs  <-  rankLocReg(xall=thinned_cormorant_data$x_thin, yall=thinned_cormorant_data$y_thin, alpha=0.2, 
